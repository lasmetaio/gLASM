...
/**
 * @title gLasm
 * @dev gLasm is an ERC721A contract that allows minting of NFTs with tier-based boosting features. 
...
contract gLasm is ERC721A, LasmOwnable, Pausable, ReentrancyGuard  {
     ...
     */
    constructor() ERC721A("Lasm Booster", "gLasm") {
